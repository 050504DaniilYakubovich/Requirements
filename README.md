...
**Описание.** Должна быть кнопка, при нажатии на которую будут удалены указаные пользователи файлы в списке найденныз дубликатов.  
**Требования.** Удаление должна работать только при уловии, если пользователь нашел и указал удаляемы дубликаты файлов.
